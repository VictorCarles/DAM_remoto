...
let exaP1 = readlineSync.questionInt('Nota primer examen: ');
let exaP2 = readlineSync.questionInt('Nota segundo examen: ');
let exaP3 = readlineSync.questionInt('Nota tercer examen: ');
...
promedioNotas = ( exaP1 + exaP2 + exaP3)/3;
