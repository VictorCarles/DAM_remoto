...
let edadHermano1 = readlineSync.questionInt('Introduce la edad del primer hermano: ');
let edadHermano2 = readlineSync.questionInt('Introduce la edad del segundo hermano: ');
